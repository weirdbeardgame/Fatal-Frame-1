  ...
  do {
    ...
    if (*puVar7 != 0xffffffff) {
      ...
      do {
        do {
          iVar6 = iVar2;
          if (1 < iVar6) goto LAB_00114ea8;
          room_id_00 = *puVar4;
          puVar4 = room_id + iVar6 + 1;
          iVar2 = iVar6 + 1;
        } while (room_id_00 == 0xff);
        uVar3 = GetSdrEventSe(room_id_00);
        puVar4 = room_id + iVar6 + 1;
      } while (*puVar7 != uVar3);
      bVar1 = true;
LAB_00114ea8:
...
LAB_00114f68:
      ...
      for (iVar3 = 1; iVar3 < 2; iVar3 = iVar3 + 1) {
        if (se_ctrl.event_no[iVar3] == uVar2) goto LAB_00114f68;
      }
    }
    if (!bVar1) {
      *ld_tbl = uVar2;
...
int SEventLoadReqAndSetSub(int load_id, u_char room_from, u_char room_to) {
  ...
  if (load_file_no != 0xffffffff) {
    for (iVar2 = 0; iVar2 < 2; iVar2 = iVar2 + 1) {
      if (*puVar4 == '\0') {
        iVar2 = SeFileLoadAndSet(load_file_no,iVar2 + 0x13);
        *puVar4 = '\x01';
        return iVar2;
      }
...
int SEventLoadReqAndSet(int load_id, u_short door_id) {
  ...
  if (*pbVar2 != 0) {
    ...
    while (sVar1 != door_id) {
      iVar4 = iVar4 + 1;
      psVar3 = psVar3 + 2;
      if ((int)(uint)*pbVar2 <= iVar4) goto LAB_001150dc;
      sVar1 = *psVar3;
    }
...
LAB_001150dc:
  if ((room_to != 0xff) && (room_id != room_to)) {
    load_id = SEventLoadReqAndSetSub(load_id,room_id,room_to);
  }
  return load_id;
}

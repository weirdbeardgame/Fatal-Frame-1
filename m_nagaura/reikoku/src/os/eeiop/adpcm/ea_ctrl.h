...
#ifndef M_NAGAURA_REIKOKU_SRC_OS_EEIOP_ADPCM_EA_CTRL_H
#define M_NAGAURA_REIKOKU_SRC_OS_EEIOP_ADPCM_EA_CTRL_H
...
#endif // M_NAGAURA_REIKOKU_SRC_OS_EEIOP_ADPCM_EA_CTRL_H

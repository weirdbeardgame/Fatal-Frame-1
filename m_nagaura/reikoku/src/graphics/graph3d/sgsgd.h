...
#ifndef M_NAGAURA_REIKOKU_SRC_GRAPHICS_GRAPH3D_SGSGD_H
#define M_NAGAURA_REIKOKU_SRC_GRAPHICS_GRAPH3D_SGSGD_H
...
#endif // M_NAGAURA_REIKOKU_SRC_GRAPHICS_GRAPH3D_SGSGD_H

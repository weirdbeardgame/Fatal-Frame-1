...
#ifndef M_NAGAURA_REIKOKU_SRC_GRAPHICS_MOTION_MDLACT_H
#define M_NAGAURA_REIKOKU_SRC_GRAPHICS_MOTION_MDLACT_H
...
#endif // M_NAGAURA_REIKOKU_SRC_GRAPHICS_MOTION_MDLACT_H

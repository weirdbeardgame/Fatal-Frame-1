...
#ifndef M_NAGAURA_REIKOKU_SRC_GRAPHICS_MOTION_MDLWORK_H
#define M_NAGAURA_REIKOKU_SRC_GRAPHICS_MOTION_MDLWORK_H
...
#endif // M_NAGAURA_REIKOKU_SRC_GRAPHICS_MOTION_MDLWORK_H

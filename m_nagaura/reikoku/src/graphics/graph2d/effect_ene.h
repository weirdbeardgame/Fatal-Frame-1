...
#ifndef M_NAGAURA_REIKOKU_SRC_GRAPHICS_GRAPH2D_EFFECT_ENE_H
#define M_NAGAURA_REIKOKU_SRC_GRAPHICS_GRAPH2D_EFFECT_ENE_H
...
#endif // M_NAGAURA_REIKOKU_SRC_GRAPHICS_GRAPH2D_EFFECT_ENE_H

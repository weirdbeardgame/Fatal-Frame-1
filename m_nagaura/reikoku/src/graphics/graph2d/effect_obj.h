...
#ifndef M_NAGAURA_REIKOKU_SRC_GRAPHICS_GRAPH2D_EFFECT_OBJ_H
#define M_NAGAURA_REIKOKU_SRC_GRAPHICS_GRAPH2D_EFFECT_OBJ_H
...
#endif // M_NAGAURA_REIKOKU_SRC_GRAPHICS_GRAPH2D_EFFECT_OBJ_H

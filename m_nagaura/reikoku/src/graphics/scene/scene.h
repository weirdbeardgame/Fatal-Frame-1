...
#ifndef M_NAGAURA_REIKOKU_SRC_GRAPHICS_SCENE_SCENE_H
#define M_NAGAURA_REIKOKU_SRC_GRAPHICS_SCENE_SCENE_H
...
#endif // M_NAGAURA_REIKOKU_SRC_GRAPHICS_SCENE_SCENE_H

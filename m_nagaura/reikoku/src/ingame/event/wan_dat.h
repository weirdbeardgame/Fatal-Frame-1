...
#ifndef M_NAGAURA_REIKOKU_SRC_INGAME_EVENT_WAN_DAT_H
#define M_NAGAURA_REIKOKU_SRC_INGAME_EVENT_WAN_DAT_H
...
#endif // M_NAGAURA_REIKOKU_SRC_INGAME_EVENT_WAN_DAT_H

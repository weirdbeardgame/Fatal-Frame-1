#ifndef M_NAGAURA_REIKOKU_SRC_INGAME_EVENT_EV_MAIN_H
#define M_NAGAURA_REIKOKU_SRC_INGAME_EVENT_EV_MAIN_H
#include "zeromath.h"
...
#endif // M_NAGAURA_REIKOKU_SRC_INGAME_EVENT_EV_MAIN_H

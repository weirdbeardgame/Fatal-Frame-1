...
#ifndef M_NAGAURA_REIKOKU_SRC_INGAME_ENTRY_AP_RGOST_H
#define M_NAGAURA_REIKOKU_SRC_INGAME_ENTRY_AP_RGOST_H
...
#endif // M_NAGAURA_REIKOKU_SRC_INGAME_ENTRY_AP_RGOST_H

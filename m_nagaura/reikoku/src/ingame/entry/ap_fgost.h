...
#ifndef M_NAGAURA_REIKOKU_SRC_INGAME_ENTRY_AP_FGOST_H
#define M_NAGAURA_REIKOKU_SRC_INGAME_ENTRY_AP_FGOST_H
...
#endif // M_NAGAURA_REIKOKU_SRC_INGAME_ENTRY_AP_FGOST_H

...
#ifndef M_NAGAURA_REIKOKU_SRC_INGAME_MENU_ITEM_GET_H
#define M_NAGAURA_REIKOKU_SRC_INGAME_MENU_ITEM_GET_H
...
#endif // M_NAGAURA_REIKOKU_SRC_INGAME_MENU_ITEM_GET_H

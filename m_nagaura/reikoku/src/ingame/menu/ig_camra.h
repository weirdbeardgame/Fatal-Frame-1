...
#ifndef M_NAGAURA_REIKOKU_SRC_INGAME_MENU_IG_CAMRA_H
#define M_NAGAURA_REIKOKU_SRC_INGAME_MENU_IG_CAMRA_H
...
#endif // M_NAGAURA_REIKOKU_SRC_INGAME_MENU_IG_CAMRA_H

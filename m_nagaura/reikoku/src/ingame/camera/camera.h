...
#ifndef M_NAGAURA_REIKOKU_SRC_INGAME_CAMERA_CAMERA_H
#define M_NAGAURA_REIKOKU_SRC_INGAME_CAMERA_CAMERA_H
...
#endif // M_NAGAURA_REIKOKU_SRC_INGAME_CAMERA_CAMERA_H

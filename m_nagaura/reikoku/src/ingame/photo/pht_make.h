...
#ifndef M_NAGAURA_REIKOKU_SRC_INGAME_PHOTO_PHT_MAKE_H
#define M_NAGAURA_REIKOKU_SRC_INGAME_PHOTO_PHT_MAKE_H
...
#endif // M_NAGAURA_REIKOKU_SRC_INGAME_PHOTO_PHT_MAKE_H

...
#ifndef M_NAGAURA_REIKOKU_SRC_OUTGAME_BTL_MODE_BTL_MENU_H
#define M_NAGAURA_REIKOKU_SRC_OUTGAME_BTL_MODE_BTL_MENU_H
...
#endif // M_NAGAURA_REIKOKU_SRC_OUTGAME_BTL_MODE_BTL_MENU_H

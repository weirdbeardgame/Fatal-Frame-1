...
#ifndef LOCAL_SCE_EE_GCC_SRC_NEWLIB_LIBC_STDLIB_MALLOCR_H
#define LOCAL_SCE_EE_GCC_SRC_NEWLIB_LIBC_STDLIB_MALLOCR_H
...
#endif // LOCAL_SCE_EE_GCC_SRC_NEWLIB_LIBC_STDLIB_MALLOCR_H

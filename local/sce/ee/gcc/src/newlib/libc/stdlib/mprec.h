...
#ifndef LOCAL_SCE_EE_GCC_SRC_NEWLIB_LIBC_STDLIB_MPREC_H
#define LOCAL_SCE_EE_GCC_SRC_NEWLIB_LIBC_STDLIB_MPREC_H
...
// warning: multiple differing types with the same name (#321, type name not equal)
...
#endif // LOCAL_SCE_EE_GCC_SRC_NEWLIB_LIBC_STDLIB_MPREC_H

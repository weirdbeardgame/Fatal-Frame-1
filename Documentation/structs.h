// File written by stdump on 2023-10-21
//
// Input file:
//   SLUS_203.88
// Toolchain version(s):
...
// warning: multiple differing types with the same name (#1, type name not equal)
...
// warning: multiple differing types with the same name (#64, type name not equal)
...
// warning: multiple differing types with the same name (#90,  not equal)
enum
{
